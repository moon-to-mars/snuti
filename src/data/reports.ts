    ...
    clinicalEntries: [
      {
        ...
        author: '박지연 선생님',
        date: '2026년 6월 24일',
        body: '준호가 보조 촉구 없이 인지 "몰입" 퀘스트를 스스로 시작하는 능력이 눈에 띄게 향상됐어요. "패턴 탐험가" 퀘스트를 12분간 지속했으며, 이는 기준치보다 40% 증가한 수치예요.',
      },
      {
        id: 'ce-2',
        type: 'observation',
        ...
        author: '임상 보조 김민수',
        date: '2026년 6월 19일',
        body: '오후 3시 세션에서 자기 조절 지표가 급등했어요. 고인지 과제를 오전 시간대로 배치하는 것을 권장해요.',
      },
      {
        id: 'ce-3',
        type: 'action',
        ...
        author: '박지연 선생님',
        date: '2026년 6월 12일',
        body: '레벨 4 퀘스트 숙달을 반영하여 개별화 교육 계획(IEP)을 업데이트했어요. 다음 달은 \'자기 조절\' 테마 모듈을 추가로 도입할 예정이에요.',
      },
    ],
    weaknesses: [
      '행동 교정 성공률 56% — 차례 기다리기, 자리 지키기에서 지속적 어려움',
      '오후 3시 이후 자기 조절 어려움 패턴 — 고난도 미션은 오전으로 배치 권장',
